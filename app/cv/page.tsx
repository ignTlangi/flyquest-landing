...
export default function CVPage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white selection:bg-flyquest-gold selection:text-black">
      ...
      {/* Hero Section */}
      <section className="relative px-6 md:px-12 lg:px-24 pt-32 pb-20">
            ...
            <div>
              ...
              <div className="mt-8 pt-8 border-t border-neutral-800">
                <div className="flex items-start gap-4">
                  <div className="w-14 h-14 bg-flyquest-gold flex items-center justify-center flex-shrink-0">
                    <span className="font-display font-bold text-black text-xl">TK</span>
                  </div>
                  <div>
      ...
      <section className="relative px-6 md:px-12 lg:px-24 py-20 bg-neutral-950 border-t border-neutral-900">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            <div className="w-32 h-32 bg-flyquest-gold flex items-center justify-center flex-shrink-0">
              <span className="font-display font-bold text-black text-4xl">TK</span>
            </div>
      ...
      <footer className="px-6 md:px-12 lg:px-24 py-12 border-t border-neutral-900">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-8">
            ...
            <Link href="/cv" className="text-flyquest-gold transition-colors text-sm font-mono">
              CV
            </Link>
